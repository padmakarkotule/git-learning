...
- Feature branches are merged into the dev branch. (**feature branch -> dev**)
- After testing and stability, the dev branch is merged into the release branch. (**dev branch -> release branch**)
- Finally, the release branch is merged into the main branch for deployment or production-ready code. (**release branch -> main branch**)
